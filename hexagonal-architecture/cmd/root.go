...
import (
	...
	dbInfra "github.com/flpcastro/fullcycle-repository/hexagonal-repository/adapters/db"
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.hexagonal-repository.yaml)")
